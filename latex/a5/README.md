# Informe — Actividad 5: Configuración DHCP y Servidor Web

Documentación LaTeX del informe de la Actividad 5 del Taller de Sistemas
Operativos II. Cubre la configuración y verificación del servidor DHCP
(Kea) y del servidor web (Nginx) como proxy inverso del proyecto
**Grupo 1 Sudoers** sobre Debian GNU/Linux 12 (Bookworm).
...
│   ├── 04-desarrollo.tex     # Capítulo III: Desarrollo (DHCP + Nginx)
...
|---|---|---|
| `captura-systemctl-kea.png` | Estado activo de Kea DHCP y su configuración | `systemctl status kea-dhcp4-server` |
| `captura-cliente-ip.png` | Dirección IP asignada al cliente por DHCP | `dhclient -v eth0` y `ip a` |
| `captura-leases.png` | Concesiones registradas por Kea | `cat /var/lib/kea/kea-leases4.csv` |
